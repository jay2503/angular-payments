  ...
  return {
    ...
    link: function(scope, elem, attr) {
      ...
      form.bind('submit', function() {
        ...
        expMonthUsed = scope.payment.expMonth ? true : false;
        expYearUsed = scope.payment.expYear ? true : false;

        if(!(expMonthUsed && expYearUsed)){
          exp = Common.parseExpiry(scope.payment.expiry)
          scope.payment.expMonth = exp.month
          scope.payment.expYear = exp.year
        }
        ...
        scope.payment.expMonth = null;
        scope.payment.expYear  = null;
